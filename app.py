...
# Routes Downloader
from routes.downloader import tiktok_bp, igdl_bp, twitter_bp, spoty_bp, trera_bp, bilibili_bp, xiaou_bp, capcut_bp, tiktokdlrek as tiktok_ns, instagramdlrek as igdl_ns, twitterdlrek as twitter_ns, spotyrek as spoty_ns, terarek as tera_ns, bilibilirek as bilibili_ns, xiaourek as xiaou_ns, capcutrek as capcut_ns
...
app.register_blueprint(xiaou_bp, url_prefix='/api/xiaohongshu')
app.register_blueprint(capcut_bp, url_prefix='/api/capcut')
# Register tools
...
api.add_namespace(xiaou_ns, path='/api/xiaohongshu')
api.add_namespace(capcut_ns, path='/api/capcut')
# NameSpace Tools
