...
# Routes Downloader
from routes.downloader import tiktok_bp, igdl_bp, twitter_bp, spoty_bp, tiktokdlrek as tiktok_ns, instagramdlrek as igdl_ns, twitterdlrek as twitter_ns, spotyrek as spoty_ns
